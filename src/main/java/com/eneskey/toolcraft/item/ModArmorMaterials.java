...
public enum ModArmorMaterials implements ArmorMaterial {
    TITANIUM_INGOT("titanium", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_IRON,
            2.0F, 0.0F, () -> Ingredient.of(ModItems.TITANIUM_INGOT.get()));
    ...
    public String getName() {
        return ToolCraft.MOD_ID + ":" + this.name;
    }
